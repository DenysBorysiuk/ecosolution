  ...
  return (
    <ul className="flex flex-col gap-[24px] md:w-[244px] xl:w-[466px] xl:gap-[32px] smOnly:mb-[24px]">
      <li>
        ...
        <a
          className="mb-[8px] flex items-center gap-[8px] text-[20px] tracking-[-0.8px] xl:mb-[16px] xl:text-[24px] xl:tracking-[-0.96px]"
          href="tel:office@ecosolution.com"
        >
          <Call className="h-[20px] w-[20px] xl:h-[24px] xl:w-[24px]" />
          38 (098) 12 34 567
        </a>
        <a
          className="flex items-center gap-[8px] text-[20px] tracking-[-0.8px]  xl:text-[24px] xl:tracking-[-0.96px]"
          href="tel:office@ecosolution.com"
        >
          <Call className="h-[20px] w-[20px] xl:h-[24px] xl:w-[24px]" />
          38 (093) 12 34 567
      ...
      <li>
        ...
        >
          <Sms className="h-[20px] w-[20px] xl:h-[24px] xl:w-[24px]" />
          office@ecosolution.com
        </a>
      </li>
      <li>
        <p className="mb-[8px] text-[16px] xl:mb-[16px]">Address:</p>
        <p className="flex items-center gap-[8px] text-[20px] tracking-[-0.8px] xl:text-[24px] xl:tracking-[-0.96px]">
